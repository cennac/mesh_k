...
#if defined(CONFIG_RTL_8366SC_SUPPORT) || defined(CONFIG_RTL_8364NB_SUPPORT) || defined(CONFIG_RTL_8367SB_SUPPORT)
...
#else
    rtk_port_rgmiiDelayExt_set(EXT_PORT_FOR_HOST, EXT0_RGMII_TX_DELAY, EXT0_RGMII_RX_DELAY); // change rxDelay to 2 to enhance the compatibility of 8197D and 8367RB
#endif
