...
void dfs_init_para_by_manual_dfs_regdomain(struct rtl8192cd_priv *priv)
{
	...
	if (priv->pshare->rf_ft_var.manual_dfs_regdomain == 1) {
		...
		if (GET_CHIP_VER(priv) == VERSION_8814B) {
			priv->pshare->rf_ft_var.pw_cnt_th = 2;
			priv->pshare->rf_ft_var.pri_rpt_lowth1 = 120;
			priv->pshare->rf_ft_var.pri_rpt_uppth1 = 4200;
		} else if (GET_CHIP_VER(priv) == VERSION_8812F) {
			priv->pshare->rf_ft_var.pw_cnt_th = 5;
			priv->pshare->rf_ft_var.pri_rpt_lowth1 = 5;
			priv->pshare->rf_ft_var.pri_rpt_uppth1 = 160;
		}
		#if defined(CONFIG_WLAN_HAL_8812FE)
			if (GET_CHIP_VER(priv) == VERSION_8812F)
				priv->pshare->rf_ft_var.pri_cnt_th = 4;
		...
		priv->pshare->rf_ft_var.pw_lowth1 = 1;
		priv->pshare->rf_ft_var.pw_uppth1 = 45;
		priv->pshare->rf_ft_var.pw_lowth2 = 48;
		priv->pshare->rf_ft_var.pw_uppth2 = 80;
		//priv->pshare->rf_ft_var.loct_cnt_th = 50;
		if (GET_CHIP_VER(priv) == VERSION_8814B) {
			priv->pshare->rf_ft_var.pw_cnt_th = 2;
...
void DFS_SetReg(struct rtl8192cd_priv *priv)
{
	...
	if (GET_CHIP_VER(priv) == VERSION_8192D) {
		...
		if (priv->pshare->rf_ft_var.manual_dfs_regdomain == 1) {
			phy_set_bb_reg(priv, 0xa40, 0xfffffff, 0xb35dc1bd);
			phy_set_bb_reg(priv, 0xa44, 0xfffffff, 0x3033bebd);
			phy_set_bb_reg(priv, 0xa48, 0xfffffff, 0x2a521254);
			phy_set_bb_reg(priv, 0xa4c, 0xfffffff, 0xa2533345);
			phy_set_bb_reg(priv, 0xa50, 0xfffffff, 0x605be083);
			phy_set_bb_reg(priv, 0xa54, 0xfffffff, 0x500009e8);
		}
		else if (priv->pshare->rf_ft_var.manual_dfs_regdomain == 3) {
			phy_set_bb_reg(priv, 0xa40, 0xfffffff, 0xb25dbbb3);
			phy_set_bb_reg(priv, 0xa44, 0xfffffff, 0x3033bea5);
			phy_set_bb_reg(priv, 0xa48, 0xfffffff, 0x2a521254);
			phy_set_bb_reg(priv, 0xa4c, 0xfffffff, 0xa2633345);
			phy_set_bb_reg(priv, 0xa50, 0xfffffff, 0x605be003);
			phy_set_bb_reg(priv, 0xa54, 0xfffffff, 0x50000968);
		}
		else if(priv->pshare->rf_ft_var.manual_dfs_regdomain == 2) {
			phy_set_bb_reg(priv, 0xa40, 0xfffffff, 0xb35dc1bd);
			phy_set_bb_reg(priv, 0xa44, 0xfffffff, 0x3033bebd);
		...
		if (priv->pshare->rf_ft_var.manual_dfs_regdomain == 1) {
			phy_set_bb_reg(priv, 0xa40, 0xfffffff, 0xb25dc1bd);
			phy_set_bb_reg(priv, 0xa44, 0xfffffff, 0x3033bead);
			phy_set_bb_reg(priv, 0xa48, 0xfffffff, 0x2a521254);
			phy_set_bb_reg(priv, 0xa4c, 0xfffffff, 0xa2533345);
			phy_set_bb_reg(priv, 0xa50, 0xfffffff, 0x605be003);
			phy_set_bb_reg(priv, 0xa54, 0xfffffff, 0x500009e8);
