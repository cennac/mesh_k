...
//-------------------------------------------------------------
#ifdef CONFIG_PCI_HCI
#if !defined(CONFIG_WLAN_HAL_8198F) && !defined(CONFIG_WLAN_HAL_8814BE)&& !defined(CONFIG_WLAN_HAL_8197G) // charlie, disable CHECK_HANGUP temporarily
#define CHECK_HANGUP
#endif
...
#if defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8814BE)
...
//-------------------------------------------------------------
#ifdef CONFIG_RTK_SMART_ROAMING && !defined(CONFIG_RTK_MULTI_AP)
