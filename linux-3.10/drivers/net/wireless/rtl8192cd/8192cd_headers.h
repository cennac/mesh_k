...
#if (BEAMFORMING_SUPPORT == 1) && (defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8814BE))
...
EXTERN void dfs_radar_distinguish_for_8814b (struct rtl8192cd_priv *priv);
#endif
