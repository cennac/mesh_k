	...
	boolean is2T)
{
	...
	if (is_main)
		odm_set_mac_reg(dm, R_0x7c4, MASKLWORD, 0x0077); /*7700*/
	else
		odm_set_mac_reg(dm, R_0x7c4, MASKLWORD, 0x00DD); /*DD00*/
...
void phy_wl_bt_coex_ant_switch_8192f(void *dm_void, boolean is_wl)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
