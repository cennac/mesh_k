...
void _iqk_set_afe_8814b(struct dm_struct *dm, boolean do_iqk)
{
	if (do_iqk) {
...
void _iqk_set_rfe_8814b(struct dm_struct *dm, boolean ext_pa_on)
{
#if 0
	if (ext_pa_on) {
		/*RFE setting*/
			     ...
			     boolean segment_iqk)
{
	...
	u32 bp_bb_reg[BB_NUM_8814B] = {0x1c38, 0x1d58, 0x1d60, 0x180c, 0x410c,
				       ...
				       0x1a14,0x1860, 0x4160, 0x5260, 0x5360};
	...
	while (1) {
		...
		_iqk_set_afe_8814b(dm, true);
		_iqk_set_rfe_8814b(dm, false);
		_iqk_start_iqk_8814b(dm, segment_iqk);
		_iqk_set_afe_8814b(dm, false);
