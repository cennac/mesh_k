...
phy_path_a_iqk_8721d(struct dm_struct *dm)
{
	...
	odm_set_rf_reg(dm, RF_PATH_A, RF_0xde, BIT(18), 0x1);

	odm_set_rf_reg(dm, RF_PATH_A, RF_0x58, 0xfc000, rf_reg_LOI);
	odm_set_rf_reg(dm, RF_PATH_A, RF_0x58, 0x03f00, rf_reg_LOQ);

	odm_set_rf_reg(dm, RF_PATH_A, RF_0xde, BIT(18), 0x0);
