	...
	boolean is_recovery)
{
	...
	if (dm->cut_version == ODM_CUT_A)
		RF_DBG(dm, DBG_RF_IQK, "[IQK] cut version is A\n");
	else if (dm->cut_version == ODM_CUT_B)
		RF_DBG(dm, DBG_RF_IQK, "[IQK] cut version is B\n");
	else if (dm->cut_version == ODM_CUT_C)
		RF_DBG(dm, DBG_RF_IQK, "[IQK] cut version is C\n");
	else if (dm->cut_version == ODM_CUT_D)
		RF_DBG(dm, DBG_RF_IQK, "[IQK] cut version is D\n");
