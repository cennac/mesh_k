	...
	boolean segment_iqk)
{
	...
	u32 backup_bb_reg[BB_REG_NUM_8812F] = {0x820, 0x824, 0x1c38, 0x1c68, 0x1d60, 0x180c, 0x410c, 0x1c3c, 0x1a14, 0x1d58, 0x1d70};
	...
	while (i < 3) {
		...
		_iqk_rfe_setting_8812f(dm, false);
...
void _phy_imr_measure_8812f(
	struct dm_struct *dm)
{
	struct dm_iqk_info *iqk_info = &dm->IQK_info;
	u32 MAC_backup[MAC_REG_NUM_8812F], BB_backup[BB_REG_NUM_8812F], RF_backup[RF_REG_NUM_8812F][SS_8812F];
	u32 backup_mac_reg[MAC_REG_NUM_8812F] = {0x520, 0x550};
	u32 backup_bb_reg[BB_REG_NUM_8812F] = {0x820, 0x824, 0x1c38, 0x1c68, 0x1d60, 0x180c, 0x410c, 0x1c3c};
	u32 backup_rf_reg[RF_REG_NUM_8812F] = {0xdf, 0x0};
...
//	_iqk_agc_bnd_int_8812f(dm);
//	_iqk_rf_setting_8812f(dm);
	_iqk_start_imr_test_8812f(dm);
	_iqk_afe_setting_8812f(dm, false);
	_iqk_restore_mac_bb_8812f(dm, MAC_backup, BB_backup, backup_mac_reg, backup_bb_reg);
	_iqk_restore_rf_8812f(dm, backup_rf_reg, RF_backup);
}

void do_imr_test_8812f(
	void *dm_void)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;

	RF_DBG(dm, DBG_RF_IQK, "[IQK]  ************IMR Test *****************\n");
	_phy_imr_measure_8812f(dm);
	...
	void *dm_void)
{
	...
	_iqk_lok_setting_8812f(dm, RF_PATH_A, 0x4);
	_lok_one_shot_8812f(dm, RF_PATH_A, false);

	_iqk_lok_setting_8812f(dm, RF_PATH_B, 0x4);
	_lok_one_shot_8812f(dm, RF_PATH_B, false);
