...
//#define BSP_WPS_BTN_PIN		BSP_GPIO_PIN_G6    //defautl value:hp commend
#define BSP_WPS_BTN_PIN		BSP_GPIO_PIN_E2    //hp add new 

/* shared */
#define BSP_RESET_LED_PIN		BSP_GPIO_PIN_H1
#define BSP_WPS_LED_PIN		BSP_GPIO_PIN_H1     //default value
//#define BSP_WPS_LED_PIN		BSP_GPIO_PIN_E3   
